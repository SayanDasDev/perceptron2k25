              ...
              <div className="bg-slate-900">
                <div className="flex justify-between items-start p-4">
                  ...
                  <motion.a
                    ...
                    href={active.ctaLink}
                    target="_blank"
                    className="px-4 py-3 text-sm rounded-full font-bold bg-primary text-background"
                  >
                    Register
                  </motion.a>
                </div>
                ...
                <div className="pl-8 py-8 relative px-4">
      ...
      <ul className="max-w-6xl mx-auto w-full gap-4 grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="p-4 flex flex-col justify-between items-center hover:bg-slate-900 dark: rounded-xl cursor-pointer"
          >
